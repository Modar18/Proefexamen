<?php
  class Docent {
    ...
    public function createDocent($post) {
      $this->db->query("INSERT INTO docent(id, afkorting, voornaam, tussenvoegsel, achternaam, email, telefoonnummer, mentorklas)
                        VALUES(:id, :afkorting, :voornaam, :tussenvoegsel, :achternaam, :email, :telefoonnummer, :mentorklas)");
